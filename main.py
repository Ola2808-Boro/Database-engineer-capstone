...
from booking import add_booking_stored_procedure,update_booking_stored_procedure,cancel_booking_stored_procedure

logging.basicConfig(filename="logs.log", level=logging.INFO, format="%(asctime)s %(message)s", filemode="w")
...
cancel_booking_stored_procedure()